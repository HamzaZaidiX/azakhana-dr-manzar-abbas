    ...
    >
      <div className="container mx-auto px-4 flex justify-between items-center relative select-none cursor-default">
        ...
        >
          ...
          >
            <h1 className=" whitespace-nowrap text-center text-xl sm:text-2xl font-semibold md:text-4xl dark:text-[#d43434] text-islamic-black hover:scale-105 hover:text-islamic-green dark:text-islamic-gold dark:hover:text-islamic-red transition-colors urdu-text">
